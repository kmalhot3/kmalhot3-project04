...
public class MyTunes 
{
	 ...
	 */
	 //tunes.getPlayList(namesOfPlayLists[playListNumber]);
	...
	private void printPlayList(String name) 
	{
		switch(name)
		{
		case "favorites": System.out.println("favorites\n" + favoritePL); break;
		case "lounge": System.out.println("lounge\n" + loungePL); break;
		case "road trip": System.out.println("road trip\n" + roadTripPL); break;
		}
	}
	...
	{
		final String DATAFILE = "music_genre_subset.json"; // Directory path for JSON file

		// TODO: Tests Jukeboxs class by enqueu-ing songs in the different playlists.
		final String TESTFILE = "tunes.txt";	// Directory path for plain-text file
		...
		int playListNumber = 0; int flag0=0, flag1=0, flag2=0;
		for (int songNumber = 0;(songNumber < numberOfSongsToPlay) && (songNumber < totalSongsToPlay);songNumber++)
		{
			...
			//System.out.println("Playlist no: "+ playListNumber);
			//System.out.println("Song Number, totalSongstoPlay, Number of Songs to play:" + songNumber + "    " + totalSongsToPlay + "   " + numberOfSongsToPlay);
		...
		for (playListNumber = 0; playListNumber < namesOfPlayLists.length; playListNumber++)
		{
			...
			//System.out.print("Peek value for"+ namesOfPlayLists[playListNumber] + "is: " + queue.peek());
			if(queue.peek() == null)
